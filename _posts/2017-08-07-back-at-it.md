...
- meta
---
I'm back at it! Well, right this very instant, I'm typing this _before_ I get back at it. Probably not the best strategy, but screw it!
...
In any case, having some sort of quantification involved. One thing I might want this for is to be able to gain some reward at the end of the 30 days; get all of them, buy a LEGO set or something. Perhaps I can create two different lists of 30 Day candidates, one which I _want_ to do (e.g. learn card magic), one which I feel I _should_ do (e.g. process baseball cards or posters). Then, if I get above a certain score threshold, I can choose from the "want" list; if I don't, I get the "don't want" list.
