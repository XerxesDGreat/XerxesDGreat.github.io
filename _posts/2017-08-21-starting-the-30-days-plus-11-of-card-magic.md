...
- meta
---
Yeah, I figured it would end up being this. I mean, I really want to learn how to do neat card tricks (not that I have an audience, but still) and I've been watching videos of them for some time. I was trying to do something else, but I figured "why wait? 30 Days is for me to do what _I_ want; I don't need to balance things from want to need to whatever else".
